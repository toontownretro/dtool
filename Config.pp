...
#define GLSLANG_LIBS \
  $[if $[WINDOWS_PLATFORM], \
    GenericCodeGen.lib glslang.lib MachineIndependent.lib OSDependent.lib SPIRV.lib glslang-default-resource-limits.lib, \
    GenericCodeGen glslang MachineIndependent OSDependent SPIRV glslang-default-resource-limits]
