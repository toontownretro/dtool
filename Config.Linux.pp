...
// How to invoke the C and C++ compilers.
  ...
  #define C++FLAGS_GEN -ftemplate-depth-70 -fno-exceptions -std=gnu++17 -fno-strict-aliasing -fno-semantic-interposition
#else
  #define CC cc
  #define CXX CC
  #define AR ar
