...
// each target.
  ...
  #define lib_targets $[forscopes python_module_target metalib_target \
    noinst_lib_target test_lib_target static_lib_target dynamic_lib_target \
    ss_lib_target,$[if $[build_target],$[ODIR]/$[lib_prefix]$[TARGET]$[dllext]$[lib_ext]]] $[real_lib_target_libs]
  ...
  // install.
  #define install_lib $[active_target(python_module_target metalib_target static_lib_target dynamic_lib_target ss_lib_target)] $[real_lib_targets]
  ...
  // directory.
  #define st_sources $[sort $[compile_sources(python_module_target metalib_target lib_target noinst_lib_target static_lib_target dynamic_lib_target ss_lib_target bin_target noinst_bin_target test_bin_target test_lib_target)]]
...
#define install_targets \
     $[active_target(python_module_target metalib_target lib_target static_lib_target dynamic_lib_target ss_lib_target):%=install-lib%] \
...
uninstall : $[active_target(python_module_target metalib_target lib_target static_lib_target dynamic_lib_target ss_lib_target):%=uninstall-lib%] $[active_target(bin_target):%=uninstall-%]
#if $[installed_files]
...
#end python_module_target metalib_target lib_target static_lib_target dynamic_lib_target ss_lib_target
