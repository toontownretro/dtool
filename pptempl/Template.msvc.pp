...
// each target.
  ...
  #defer lib_projects \
    $[active_target(python_module_target metalib_target lib_target noinst_lib_target)] \
    $[real_lib_targets]
  ...
  #defer so_sources $[get_sources(python_module_target metalib_target lib_target noinst_lib_target)]
...
#map all_sources get_sources(python_module_target metalib_target lib_target noinst_lib_target \
														 static_lib_target ss_lib_target bin_target noinst_bin_target test_bin_target)
...
#forscopes python_module_target metalib_target lib_target
...
#end $[TARGET].vcproj
#end python_module_target metalib_target lib_target
...
#define project_scopes */python_module_target */metalib_target */lib_target */static_lib_target */ss_lib_target */bin_target
