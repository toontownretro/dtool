...
/*
  ...
  */
  ...
  #define BUILDING_DTOOL_STUB
  #define BUILDING_DTOOL_DTOOLBASE
  #define BUILDING_DTOOL_DTOOLUTIL
#endif

#ifdef BUILDING_DTOOL_STUB
  #define EXPCL_DTOOL_STUB EXPORT_CLASS
  #define EXPTP_DTOOL_STUB EXPORT_TEMPL
#else
  #define EXPCL_DTOOL_STUB IMPORT_CLASS
  #define EXPTP_DTOOL_STUB IMPORT_TEMPL
#endif
